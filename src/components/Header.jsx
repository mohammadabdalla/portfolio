        ...
        <div className="container-fluid position-relative h-100 flex-lg-column ps-3 px-lg-3 pt-lg-3 pb-lg-2">
          ...
          >
            <span className="bg-dark-2 rounded-pill p-2 mb-lg-1 d-none d-lg-inline-block">
              <img
                ...
                src={process.env.PUBLIC_URL +"/images/myphoto_small.jpeg"}
                alt="Me"
              />
            </span>
          ...
          <li className="social-icons-facebook">
                <Tooltip text="Facebook" placement="top">
                  <a
                    href="https://web.facebook.com/profile.php?id=100027719169606"
                    target="_blank"
              ...
              <li className="social-icons-github">
                <Tooltip text="Github" placement="top">
                  <a
                    href="https://github.com/mohammadabdalla"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
              ...
              <li className="social-icons-linkedin">
                <Tooltip text="LinkedIn" placement="top">
                  <a
                    href="https://www.linkedin.com/in/mohammad-abdulla-0b47581b6/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
