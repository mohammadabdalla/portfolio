        ...
        <div className="row">
          <div className="col-lg-6 ">
            <div className="st-about-img-wrap">
              <div className="st-about-img st-bg custom-border" style={{ backgroundImage: `url(${imgLink})`}} data-aos="fade-right" data-aos-duration="800" data-aos-delay="400"></div>
            </div>
              ...
              <div className="st-vertical-middle-in">
                <div className={`st-text-block st-style1`} data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="500">
                  ...
                  <div className="st-text-block-btn">
                    <a className='st-btn st-style1 st-color1' href={cvPdf} target="_blank" rel="noopener noreferrer">View CV</a>
                  </div>
                </div>
              </div>
            </div>
