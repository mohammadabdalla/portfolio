...
const Portfolio = ({ classicHeader, darkTheme }) => {
  ...
  const projectsData = [
    ...
    },
    {
      ...
      thumbImage: process.env.PUBLIC_URL+"/images/projects/Screenshot-2024-02-15-125247.jpeg",
      sliderImages: [
        process.env.PUBLIC_URL+ "/images/projects/Screenshot-2024-02-15-125214.jpeg",
        process.env.PUBLIC_URL+ "/images/projects/Screenshot-2024-02-15-125241.jpeg",
      ],
    ...
    },
    {
      ...
      thumbImage:process.env.PUBLIC_URL+ "/images/projects/laragigs-1.jpeg",
      sliderImages: [
        process.env.PUBLIC_URL+ "/images/projects/laragigs-2.jpeg",
        process.env.PUBLIC_URL+ "/images/projects/laragigs-3.jpeg",
        process.env.PUBLIC_URL+ "/images/projects/laragigs-4.jpeg",
      ],
      categories: [filters.GAMES],
    },
    {
      ...
      thumbImage: process.env.PUBLIC_URL+"/images/projects/food-order-1.jpeg",
      sliderImages: [
        process.env.PUBLIC_URL+"/images/projects/food-order-2.jpeg",
        process.env.PUBLIC_URL+ "/images/projects/food-order-3.jpeg",
      ],
      categories: [filters.ECOMMERCE],
    },
    {
      ...
      thumbImage: process.env.PUBLIC_URL+"/images/projects/django-blog-1.jpeg",
      sliderImages: [
        process.env.PUBLIC_URL+"/images/projects/django-blog-3.jpeg",
        process.env.PUBLIC_URL+ "/images/projects/django-blog-2.jpeg",
      ],
      categories: [],
    }
  ];
